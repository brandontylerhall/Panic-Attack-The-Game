...
const rooms = {
    start: { //living room
        description: "Inside the LIVING ROOM, the stench of alcohol is inhibiting and the pandemonium of the party is deafening; you've never been around this many people, even on accident, and your socially inept neurons are turning to mush. You try to regain your composure by orienting yourself to your home: \n UP above you is your room. Your home. Your safe-house. The love of your life. Your... you get the point. \n STRAIGHT ahead is the KITCHEN. This is where mom makes your tendies. \n BACK behind you is obviously the door OUTSIDE, which honestly might be a better place at this point. \n to the RIGHT is the STUDY which is where MR KITTY tends to find himself. \n to your LEFT is the BATHROOM.",
        directions: {
            north: "kitchen",
            up: "stairs",
            south: "outside",
    ...
    stairs: {
        description: "You climb the stairs after what feels like an eternity. You're finally home free. Now, just gotta OPEN this DOOR...",
        /*idk maybe sumn like
        * "door": {
